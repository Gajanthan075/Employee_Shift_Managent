...
export const register = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `welcome to the shift management website.Your account has been created with${email} `,
    };
    try {
...
export const sendVerifyOtp = async (req, res) => {
  try {
    ...
    user.verifyOtp = otp;
    user.verifyOtpExpireAt = Date.now() + 24 * 60 * 60 * 1000; // fixed typo
    await user.save();
